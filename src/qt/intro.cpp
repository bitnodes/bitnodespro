...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitNodesPro Core"),
     ...
     * override -datadir in the bitnodespro.conf file in the default data directory
     * (to be consistent with bitnodesprod behavior)
     */
    if(dataDir != getDefaultDataDirectory())
